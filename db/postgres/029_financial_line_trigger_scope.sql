-- AMS PostgreSQL migration 029
-- Financial line reconciliation is enforced from line-item changes.
-- Header-level trigger was redundant and could evaluate a partially assembled
-- aggregate during conversion workflows.
