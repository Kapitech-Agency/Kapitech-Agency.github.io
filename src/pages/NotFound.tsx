  ...
  return (
    <div className="min-h-screen bg-[var(--k-bg-deep)] flex flex-col items-center justify-center px-6 overflow-hidden relative selection:bg-brand-red selection:text-white">
      ...
      >
        ...
        <h1 className="text-5xl md:text-8xl font-sans font-bold tracking-tighter mb-6 text-white">
          {language === 'id' ? 'Halaman Tidak Ditemukan.' : 'System Error 404.'}
        </h1>
        <p className="text-base md:text-xl text-[var(--k-text-secondary)] font-light max-w-md mx-auto mb-12 leading-relaxed">
          {language === 'id'
