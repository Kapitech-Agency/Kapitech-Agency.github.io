...
export const NotFound = () => {
  ...
  return (
    <div className="min-h-screen bg-[var(--k-bg)] flex flex-col items-center justify-center px-6 overflow-hidden relative selection:bg-brand-red selection:text-white">
