...
export const NotFound = () => {
  ...
  return (
    <div className="min-h-screen bg-black flex flex-col items-center justify-center px-6 overflow-hidden relative selection:bg-brand-red selection:text-white">
      ...
      >
        ...
        <p className="text-base md:text-xl text-white/50 font-light max-w-md mx-auto mb-12 leading-relaxed">
          {language === 'id'
        ...
        <div className="flex flex-col md:flex-row items-center justify-center gap-4 md:gap-6">
          <Link 
            to="/" 
            className="group px-8 md:px-10 py-4 md:py-5 bg-white text-black rounded-full font-bold flex items-center gap-3 hover:bg-brand-red hover:text-white transition-all duration-300 text-xs md:text-sm uppercase tracking-wider"
          >
          ...
          <Link 
            to="/contact" 
            className="px-8 md:px-10 py-4 md:py-5 rounded-full border border-white/20 hover:bg-white/10 hover:border-brand-red/50 transition-all font-semibold tracking-wider uppercase text-xs text-white"
          >
