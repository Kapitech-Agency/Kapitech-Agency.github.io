      ...
      <div className="ams-dashboard-header flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        ...
        {canManageClients && (
          <button
            ...
            className="min-h-10 px-4 rounded-control bg-[var(--accent)] hover:bg-[var(--accent)] text-white text-xs font-sans font-medium transition-colors flex items-center justify-center gap-1.5 self-start sm:self-auto"
          >
            <Plus size={14} />
