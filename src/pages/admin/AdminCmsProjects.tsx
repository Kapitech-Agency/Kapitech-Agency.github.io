...
export const AdminCmsProjects: React.FC = () => {
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 pb-6 border-b border-[rgba(255,255,255,0.07)]">
        ...
        <div className="flex items-center gap-3">
          <button
            ...
            className="px-4 py-2.5 rounded-xl bg-[var(--k-red)] hover:bg-[var(--k-red)] text-white text-xs font-sans font-bold transition-all flex items-center gap-2 shadow-lg shadow-[var(--k-red)]/20"
          >
            <Plus size={15} />
      ...
      <div className="bg-[var(--k-bg)] border border-[rgba(255,255,255,0.07)] p-4 rounded-2xl">
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
          <div className="relative sm:col-span-2">
            ...
            <input
              ...
              className="w-full pl-10 pr-4 py-2.5 bg-[var(--k-surface)] border border-[rgba(255,255,255,0.07)] rounded-xl text-xs text-white focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--k-red)]/40 focus:border-[var(--k-red)] placeholder:text-[var(--k-text-tertiary)] font-sans min-h-[44px]"
            />
          </div>
      ...
      >
        {filteredProjects.map((project) => (
          <div
            key={project.id}
            className="bg-[var(--k-bg)] border border-[rgba(255,255,255,0.07)] hover:border-[rgba(255,255,255,0.15)] rounded-2xl overflow-hidden flex flex-col group transition-all"
          >
            {/* Image Thumbnail */}
            <div className="relative h-48 w-full bg-[var(--k-bg)] overflow-hidden">
              <img
                src={project.image}
                alt={project.title}
            ...
            <div className="p-5 flex-1 flex flex-col justify-between space-y-4 font-sans text-xs">
              <p className="text-[var(--k-text-secondary)] line-clamp-2 font-sans text-xs">
              ...
              <div className="flex flex-wrap gap-1.5">
                {project.technologies.slice(0, 4).map((tech, idx) => (
                  <span
                    key={idx}
                    className="text-[10px] font-sans px-2 py-0.5 rounded bg-[var(--k-surface)] border border-[rgba(255,255,255,0.07)] text-[var(--k-text-secondary)]"
                  >
                    {tech}
                  </span>
                ))}
                {project.technologies.length > 4 && (
                  <span className="text-[10px] font-sans px-1.5 py-0.5 rounded bg-[var(--k-surface)] border border-[rgba(255,255,255,0.07)] text-[var(--k-text-tertiary)]">
                    +{project.technologies.length - 4}
                  </span>
                )}
              </div>
              ...
              <div className="pt-3 border-t border-[rgba(255,255,255,0.07)] flex items-center justify-between">
                <div className="text-[10px] text-[var(--k-text-tertiary)]">
                ...
                <div className="flex items-center gap-1.5">
                  <button
                    ...
                    className="p-1.5 rounded-lg bg-[var(--k-surface)] hover:bg-[var(--k-surface)] text-[var(--k-text-secondary)] hover:text-white border border-[rgba(255,255,255,0.07)] transition-colors"
                  ...
                  <button
                    ...
                    className="p-1.5 rounded-lg bg-[var(--k-surface)] hover:bg-red-950/40 text-[var(--k-text-secondary)] hover:text-red-400 border border-[rgba(255,255,255,0.07)] hover:border-red-500/30 transition-colors"
      ...
      {isModalOpen && editingProject && (
        <div className="fixed inset-0 bg-black/80 backdrop-blur-sm z-50 flex items-center justify-center p-4 overflow-y-auto">
          <div className="bg-[var(--k-bg)] border border-[rgba(255,255,255,0.07)] rounded-2xl max-w-3xl w-full max-h-[90vh] overflow-y-auto p-6 sm:p-8 shadow-2xl font-sans text-xs">
            ...
            <div className="flex items-center justify-between pb-4 border-b border-[rgba(255,255,255,0.07)] mb-6">
              ...
              <div className="flex items-center gap-3">
                {/* Modal Tab Switcher */}
                <div className="flex items-center rounded-lg bg-[var(--k-surface)] border border-[rgba(255,255,255,0.07)] p-0.5">
                  <button
                    type="button"
                    onClick={() => setModalTab('details')}
                    className={`px-3 py-1 rounded-md text-[11px] font-semibold transition-all ${
                      modalTab === 'details' ? 'bg-[#1E222A] text-white' : 'text-[var(--k-text-secondary)] hover:text-white'
                    }`}
                  >
                    Details
                  </button>
                  <button
                    ...
                    className={`flex items-center gap-1.5 px-3 py-1 rounded-md text-[11px] font-semibold transition-all ${
                      modalTab === 'preview' ? 'bg-[#1E222A] text-white' : 'text-[var(--k-text-secondary)] hover:text-white'
                    }`}
                  >
                    <Eye size={12} />
                ...
                <button
                  ...
                  className="p-1.5 rounded-lg bg-[var(--k-surface)] hover:bg-[var(--k-surface)] text-[var(--k-text-secondary)] hover:text-white border border-[rgba(255,255,255,0.07)]"
                >
                  <X size={15} />
                </button>
              </div>
            ...
            {modalTab === 'preview' ? (
              <div className="py-6 flex flex-col items-center">
                <div className="text-[11px] text-[var(--k-text-secondary)] mb-4">
                ...
                <div className="w-full max-w-sm bg-[var(--k-bg)] border border-[rgba(255,255,255,0.07)] rounded-2xl overflow-hidden shadow-2xl">
                  ...
                  <div className="p-4 space-y-3 font-sans text-xs">
                    <p className="text-[var(--k-text-secondary)] text-xs font-sans">
                      {editingProject.descId || editingProject.desc || 'No description entered.'}
                    </p>
                    <div className="flex flex-wrap gap-1">
                      {editingProject.technologies.map((t, idx) => (
                        <span key={idx} className="text-[10px] px-2 py-0.5 rounded bg-[var(--k-surface)] border border-[rgba(255,255,255,0.07)] text-[var(--k-text-secondary)]">
                          {t}
                        </span>
                      ))}
                    </div>
                    {editingProject.impact && editingProject.impact.length > 0 && (
                      <div className="grid grid-cols-2 gap-2 pt-2 border-t border-[rgba(255,255,255,0.07)]">
                        {editingProject.impact.map((imp, idx) => (
                          <div key={idx} className="bg-[var(--k-surface)] p-2 rounded-lg border border-[rgba(255,255,255,0.07)]">
                            <div className="text-[9px] text-[var(--k-text-secondary)] uppercase">{imp.label}</div>
              ...
              <form onSubmit={handleSaveModal} className="space-y-4">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div>
                    <label className="block text-[var(--k-text-secondary)] mb-1 font-semibold">Project Title *</label>
                    <input
                      type="text"
                      required
                      ...
                      className="w-full px-3.5 py-2.5 bg-[var(--k-surface)] border border-[rgba(255,255,255,0.07)] rounded-xl text-white focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--k-red)]/40 focus:border-[var(--k-red)] font-sans"
                    />
                  </div>

                  <div>
                    <label className="block text-[var(--k-text-secondary)] mb-1 font-semibold">Client Name / Company</label>
                    <input
                      type="text"
                ...
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                  <div>
                    <label className="block text-[var(--k-text-secondary)] mb-1 font-semibold">Studio Pillar</label>
                    <select
                      value={editingProject.pillar}
                      onChange={(e) => setEditingProject({ ...editingProject, pillar: e.target.value as any })}
                      className="w-full px-3 py-2.5 bg-[var(--k-surface)] border border-[rgba(255,255,255,0.07)] rounded-xl text-white focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--k-red)]/40 focus:border-[var(--k-red)] font-sans"
                    >
                  ...
                  <div>
                    <label className="block text-[var(--k-text-secondary)] mb-1 font-semibold">Release Year</label>
                    <input
                      type="text"
                ...
                <div>
                  ...
                  <div 
                    ...
                    className={`border-2 border-dashed rounded-xl p-4 text-center transition-all ${
                      isDraggingFile 
                        ? 'border-[var(--k-red)] bg-[var(--k-red)]/10' 
                        : 'border-[rgba(255,255,255,0.07)] bg-[var(--k-surface)] hover:border-[rgba(255,255,255,0.15)]'
                    }`}
                  >
                    <div className="flex flex-col items-center justify-center gap-2">
                      {editingProject.image ? (
                        ...
                        <UploadCloud className="text-[var(--k-text-secondary)]" size={28} />
                      )}
                      
                      <div className="text-white">
                        <span>Drag & drop image here, or </span>
                        <label className="text-[var(--k-red)] cursor-pointer hover:underline font-bold">
                          browse file
                          <input
                            type="file"
                            accept="image/*"
                      ...
                      <p className="text-[10px] text-[var(--k-text-tertiary)]">PNG, JPG, WebP up to 10MB</p>
                    </div>
                  </div>
                  ...
                  <div className="mt-2">
                    <input
                      ...
                      className="w-full px-3.5 py-2 bg-[var(--k-surface)] border border-[rgba(255,255,255,0.07)] rounded-xl text-white focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--k-red)]/40 focus:border-[var(--k-red)] font-sans"
                    />
                  </div>
                </div>

                <div>
                  <label className="block text-[var(--k-text-secondary)] mb-1 font-semibold">Short Executive Summary</label>
                  <textarea
                    rows={2}
                    ...
                    className="w-full px-3.5 py-2 bg-[var(--k-surface)] border border-[rgba(255,255,255,0.07)] rounded-xl text-white focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--k-red)]/40 focus:border-[var(--k-red)] font-sans text-xs"
                  />
                </div>

                {/* Tech Stack Chip Manager */}
                <div>
                  <label className="block text-[var(--k-text-secondary)] mb-1 font-semibold">Tech Stack & Frameworks</label>
                  <div className="flex gap-2 mb-2">
                    <input
                      ...
                      className="flex-1 px-3.5 py-2 bg-[var(--k-surface)] border border-[rgba(255,255,255,0.07)] rounded-xl text-white focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--k-red)]/40 focus:border-[var(--k-red)]"
                    />
                    <button
                      type="button"
                      onClick={handleAddTech}
                      className="px-3.5 py-2 rounded-xl bg-[var(--k-surface)] hover:bg-[var(--k-surface)] text-white border border-[rgba(255,255,255,0.07)]"
                    >
                      Add Tag
                    </button>
                  </div>
                  <div className="flex flex-wrap gap-1.5">
                    {editingProject.technologies.map((tech, idx) => (
                      <span
                        key={idx}
                        className="inline-flex items-center gap-1.5 px-2.5 py-1 rounded-lg bg-[var(--k-surface)] border border-[rgba(255,255,255,0.07)] text-[#D0D4DC] text-[11px]"
                      >
                        <span>{tech}</span>
                        <button
                          type="button"
                          onClick={() => handleRemoveTech(tech)}
                          className="text-[var(--k-text-secondary)] hover:text-red-400"
                        >
                          ✕
                        </button>
                      </span>
                ...
                <div>
                  <label className="block text-[var(--k-text-secondary)] mb-1 font-semibold">Impact Metrics & Key Results</label>
                  <div className="flex gap-2 mb-2">
                    <input
                      type="text"
                      value={metricLabel}
                    ...
                    <input
                      ...
                      className="w-32 px-3.5 py-2 bg-[var(--k-surface)] border border-[rgba(255,255,255,0.07)] rounded-xl text-white focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--k-red)]/40 focus:border-[var(--k-red)]"
                    />
                    <button
                      type="button"
                  ...
                  {editingProject.impact && editingProject.impact.length > 0 && (
                    <div className="flex flex-wrap gap-2">
                      {editingProject.impact.map((imp, idx) => (
                        <div key={idx} className="flex items-center gap-2 px-3 py-1.5 rounded-lg bg-[var(--k-surface)] border border-[rgba(255,255,255,0.07)]">
                          <span className="text-[var(--k-text-secondary)]">{imp.label}:</span>
                          <span className="text-emerald-400 font-bold">{imp.value}</span>
                          <button
                            type="button"
                            onClick={() => handleRemoveImpactMetric(idx)}
                            className="text-[var(--k-text-secondary)] hover:text-red-400 ml-1"
                          >
                            ✕
                          </button>
                        </div>
                ...
                <div className="pt-3 border-t border-[rgba(255,255,255,0.07)] flex items-center justify-between">
                  <label className="flex items-center gap-2 cursor-pointer">
                    <input
                      ...
                      className="w-4 h-4 rounded bg-[var(--k-surface)] border-[rgba(255,255,255,0.07)] text-[var(--k-red)] accent-brand-red"
                    />
                  ...
                  <div className="flex items-center gap-2">
                    <button
                      type="button"
                      onClick={() => setIsModalOpen(false)}
                      className="px-4 py-2 rounded-xl bg-[var(--k-surface)] text-[var(--k-text-secondary)] hover:text-white border border-[rgba(255,255,255,0.07)]"
                    >
                      Cancel
                    </button>
                    <button
                      type="submit"
                      className="px-5 py-2 rounded-xl bg-[var(--k-red)] text-white font-bold hover:bg-[var(--k-red)] transition-all shadow-md shadow-[var(--k-red)]/20"
                    >
                      Save Case Study
                    </button>
                  </div>
