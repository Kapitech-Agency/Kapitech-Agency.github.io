...
export const AdminSettings: React.FC = () => {
  ...
  return (
    <div className="space-y-6">
        ...
        <button
          ...
          className={`px-4 py-2.5 rounded-xl text-xs font-mono transition-all flex items-center gap-2 shrink-0 min-h-[44px] ${
            activeTab === 'profile'
              ...
              : 'text-[var(--k-text-secondary)] hover:text-white hover:bg-[var(--k-surface-raised)]'
          }`}
        >
          <UserCheck size={15} />
      ...
      {activeTab === 'profile' && (
        <div className="w-full max-w-4xl bg-[var(--k-surface)] border border-[rgba(255,255,255,0.07)] rounded-2xl p-5 sm:p-8">
          <div className="flex items-center gap-3 mb-6 pb-4 border-b border-[rgba(255,255,255,0.07)]">
            ...
            <div>
              ...
              <p className="text-xs text-[var(--k-text-secondary)] font-mono">
                {language === 'id' 
          ...
          <form onSubmit={handleUpdateSecurity} className="space-y-4">
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div>
                <label className="block text-xs font-mono text-[var(--k-text-secondary)] mb-1 font-semibold">
                ...
                <input
                  ...
                  className="w-full px-3.5 py-2.5 bg-[var(--k-surface-raised)] border border-[rgba(255,255,255,0.07)] rounded-xl text-xs text-white focus:outline-none focus:border-[var(--k-red)] font-mono min-h-[44px]"
                />
              </div>
            ...
            <div className="p-4 bg-[var(--k-surface-raised)] border border-[rgba(255,255,255,0.07)] rounded-xl space-y-2">
              ...
              <div className="flex items-center justify-between text-xs font-mono">
                ...
                <span className="text-[var(--k-text-muted)]">{new Date(session?.user.lastLogin || Date.now()).toLocaleString()}</span>
              </div>
            </div>
            ...
            <div className="pt-4 flex items-center justify-end">
              <button
                ...
                className="px-5 py-2.5 rounded-xl bg-[var(--k-red)] text-white text-xs font-mono font-bold hover:bg-[var(--k-red-hover)] transition-all shadow-md shadow-[var(--k-red)]/20 flex items-center gap-2 disabled:opacity-50 min-h-[44px]"
              >
          ...
          <form onSubmit={handleSaveMeta} className="space-y-4">
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              ...
              <div>
                ...
                <input
                  ...
                  disabled
                  className="w-full px-3.5 py-2.5 bg-[var(--k-surface-raised)]/50 border border-[rgba(255,255,255,0.07)] rounded-xl text-xs text-[var(--k-text-secondary)] font-mono cursor-not-allowed min-h-[44px]"
                />
              </div>
            </div>
            ...
            <div>
              ...
              <textarea
                ...
                className="w-full px-3.5 py-2.5 bg-[var(--k-surface-raised)] border border-[rgba(255,255,255,0.07)] rounded-xl text-xs text-white focus:outline-none focus:border-[var(--k-red)] font-mono"
              />
            </div>
            ...
            <div className="pt-4 border-t border-[rgba(255,255,255,0.07)] space-y-3">
              <label className="flex items-center gap-3 cursor-pointer select-none">
                <input
                  ...
                  className="w-4 h-4 rounded bg-[var(--k-surface-raised)] border-[rgba(255,255,255,0.07)] text-[var(--k-red)] accent-[var(--k-red)]"
                />
            ...
            <div className="pt-4 flex items-center justify-end">
              <button
                type="submit"
                className="px-5 py-2.5 rounded-xl bg-[var(--k-red)] text-white text-xs font-mono font-bold hover:bg-[var(--k-red-hover)] transition-all shadow-md shadow-[var(--k-red)]/20 flex items-center gap-2 min-h-[44px]"
              >
                <Save size={14} />
      ...
      {activeTab === 'rbac' && canManageAdminAccounts && (
        <div className="w-full space-y-6">
          ...
          <div className="bg-[var(--k-surface)] border border-[rgba(255,255,255,0.07)] rounded-2xl p-5 sm:p-8 space-y-6">
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 pb-5 border-b border-[rgba(255,255,255,0.07)]">
              <div className="flex items-center gap-3">
                <div className="w-10 h-10 rounded-xl bg-[var(--k-red)]/10 border border-[var(--k-red)]/30 flex items-center justify-center text-[var(--k-red-hover)] shrink-0">
                  <Users size={20} />
                </div>
                <div>
                  <h2 className="text-base font-bold font-display text-white">
              ...
              <button
                ...
                className="h-10 px-4 min-h-[40px] rounded-xl bg-[var(--k-red)] text-white text-xs font-mono font-bold hover:bg-[var(--k-red-hover)] transition-all shadow-md shadow-[var(--k-red)]/20 flex items-center justify-center gap-2 self-start sm:self-auto shrink-0"
              >
                <UserPlus size={15} />
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
              {accounts.map((acc) => {
                ...
                return (
                  <div 
                    key={acc.id}
                    className="p-4 rounded-xl bg-[var(--k-surface-raised)] border border-[rgba(255,255,255,0.07)] flex flex-col justify-between hover:border-[rgba(255,255,255,0.15)] transition-all space-y-4"
                  >
                    <div>
                      <div className="flex items-start justify-between gap-2 mb-2.5">
                        <div className="flex items-center gap-2.5">
                          ...
                          <div>
                            ...
                            <p className="text-[11px] font-mono text-[var(--k-text-secondary)]">@{acc.username}</p>
                          </div>
                        </div>
                    ...
                    <div className="pt-3 border-t border-[rgba(255,255,255,0.07)] flex items-center justify-between gap-2">
                      <button
                        ...
                        className="h-8 px-2.5 rounded-lg bg-[var(--k-border)] hover:bg-[#323640] text-gray-200 text-[11px] font-mono font-medium flex items-center gap-1.5 transition-colors"
                      >
                        <Sliders size={13} className="text-[var(--k-red-hover)]" />
                      ...
                      {!isMaster ? (
                        <button
                          ...
                          className="h-8 px-2 rounded-lg hover:bg-red-500/10 text-[var(--k-text-secondary)] hover:text-red-400 text-[11px] font-mono transition-colors flex items-center gap-1"
                          title="Hapus Akun"
                        >
                          <Trash2 size={13} />
                        ...
                        <span className="text-[10px] font-mono text-[var(--k-text-muted)] italic">Root Master</span>
                      )}
                    </div>
                  </div>
                );
          ...
          <div className="w-full bg-[var(--k-surface)] border border-[rgba(255,255,255,0.07)] rounded-2xl p-5 sm:p-8 space-y-6">
            ...
            <div className="overflow-x-auto custom-scrollbar">
              <table className="w-full text-xs font-mono text-left border-collapse min-w-[650px]">
                ...
                <tbody className="divide-y divide-[rgba(255,255,255,0.07)]">
                  <tr className="hover:bg-[var(--k-surface-raised)]/60 transition-colors">
      ...
      {isAddAccountModalOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-0 sm:p-4 bg-black/80 backdrop-blur-sm overflow-y-auto">
          <div className="w-full h-full sm:h-auto sm:max-h-[90vh] sm:max-w-2xl bg-[var(--k-surface)] border-0 sm:border sm:border-[rgba(255,255,255,0.07)] rounded-none sm:rounded-2xl shadow-2xl flex flex-col overflow-hidden">
            ...
            <div className="sticky top-0 z-20 bg-[var(--k-surface)]/95 backdrop-blur-md px-5 sm:px-6 py-4 border-b border-[rgba(255,255,255,0.07)] flex items-center justify-between shrink-0">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-[11px] font-mono text-[var(--k-text-secondary)]">
              ...
              <button
                ...
                className="w-8 h-8 rounded-lg bg-[var(--k-surface-raised)] hover:bg-[var(--k-border)] text-[var(--k-text-secondary)] hover:text-white flex items-center justify-center transition-colors shrink-0"
              >
                <X size={16} />
              </button>
            </div>
            ...
            <form onSubmit={handleCreateAccountSubmit} className="flex-1 overflow-y-auto p-5 sm:p-6 space-y-5 custom-scrollbar">
              ...
              <div>
                <label className="block text-xs font-mono text-[var(--k-text-secondary)] uppercase tracking-wider mb-2 font-semibold">
                  ...
                  <button
                    ...
                    className={`p-3.5 rounded-xl border text-left transition-all ${
                      newAccRole === 'Stakeholder Executive'
                        ...
                        : 'bg-[var(--k-surface-raised)] border-[rgba(255,255,255,0.07)] hover:border-[rgba(255,255,255,0.15)]'
                    }`}
                  >
                    ...
                    <p className="text-[11px] text-[var(--k-text-secondary)] leading-relaxed font-mono">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div>
                  <label className="block text-xs font-mono text-[var(--k-text-secondary)] uppercase tracking-wider mb-1.5 font-semibold">
                  ...
                  <input
                    ...
                    className="w-full px-3.5 py-2.5 bg-[var(--k-surface-raised)] border border-[rgba(255,255,255,0.07)] rounded-xl text-sm text-white font-mono focus:outline-none focus:border-[var(--k-red)] transition-all"
                  />
                </div>
              ...
              <div>
                <label className="block text-xs font-mono text-[var(--k-text-secondary)] uppercase tracking-wider mb-2 font-semibold flex items-center justify-between">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 p-3 bg-[#0E1015] border border-[rgba(255,255,255,0.07)] rounded-xl max-h-48 overflow-y-auto custom-scrollbar">
                  {[
                    ...
                    <label 
                      key={item.key}
                      className="flex items-center gap-2 p-2 rounded-lg bg-[var(--k-surface-raised)]/50 hover:bg-[var(--k-surface-raised)] cursor-pointer text-xs font-mono transition-colors"
                    >
                      <input
                        type="checkbox"
                        ...
                        className="w-4 h-4 rounded bg-[var(--k-bg)] border-[rgba(255,255,255,0.1)] text-[var(--k-red)] accent-[var(--k-red)]"
                      />
              ...
              {/* Sticky Footer */}
              <div className="sticky bottom-0 -mx-5 sm:-mx-6 -mb-5 sm:-mb-6 mt-4 bg-[var(--k-surface)]/95 backdrop-blur-md px-5 sm:px-6 py-3.5 border-t border-[rgba(255,255,255,0.07)] flex items-center justify-end gap-3 shrink-0">
                <button
                  type="button"
                  onClick={() => setIsAddAccountModalOpen(false)}
                  className="h-10 px-4 min-h-[40px] rounded-xl bg-[var(--k-surface-raised)] text-[var(--k-text-secondary)] hover:text-white text-xs font-mono font-bold transition-colors"
                >
                  {language === 'id' ? 'Batal' : 'Cancel'}
                </button>
                <button
                  type="submit"
                  className="h-10 px-5 min-h-[40px] rounded-xl bg-[var(--k-red)] text-white text-xs font-mono font-bold hover:bg-[var(--k-red-hover)] transition-all shadow-md shadow-[var(--k-red)]/20 flex items-center gap-2"
                >
                  <Save size={14} />
      ...
      {isEditPermsModalOpen && editingAccount && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-0 sm:p-4 bg-black/80 backdrop-blur-sm overflow-y-auto">
          <div className="w-full h-full sm:h-auto sm:max-h-[90vh] sm:max-w-xl bg-[var(--k-surface)] border-0 sm:border sm:border-[rgba(255,255,255,0.07)] rounded-none sm:rounded-2xl shadow-2xl flex flex-col overflow-hidden">
            ...
            <div className="flex-1 overflow-y-auto p-5 sm:p-6 space-y-2.5 custom-scrollbar">
              {[
                ...
                <label 
                  key={item.key}
                  className="flex items-center justify-between p-3 rounded-xl bg-[var(--k-surface-raised)] border border-[rgba(255,255,255,0.07)] hover:border-[rgba(255,255,255,0.15)] cursor-pointer text-xs font-mono transition-colors"
                >
            ...
            {/* Sticky Footer */}
            <div className="sticky bottom-0 bg-[var(--k-surface)]/95 backdrop-blur-md px-5 sm:px-6 py-3.5 border-t border-[rgba(255,255,255,0.07)] flex items-center justify-end gap-3 shrink-0">
              <button
                type="button"
                onClick={() => setIsEditPermsModalOpen(false)}
                className="h-10 px-4 min-h-[40px] rounded-xl bg-[var(--k-surface-raised)] text-[var(--k-text-secondary)] hover:text-white text-xs font-mono font-bold transition-colors"
      ...
      {activeTab === 'security' && (
        <div className="w-full max-w-4xl bg-[var(--k-surface)] border border-[rgba(255,255,255,0.07)] rounded-2xl p-5 sm:p-8 space-y-6">
          <div className="flex items-center gap-3 pb-4 border-b border-[rgba(255,255,255,0.07)]">
          ...
          <div className="space-y-4">
            <div className="p-4 bg-[var(--k-surface-raised)] border border-[rgba(255,255,255,0.07)] rounded-xl flex flex-col sm:flex-row sm:items-center justify-between gap-3">
              <div className="space-y-1">
                ...
                <p className="text-[var(--k-text-secondary)] text-[11px] font-mono">
                  {language === 'id'
              ...
              <button
                ...
                className={`px-3.5 py-1.5 rounded-lg text-xs font-mono font-bold transition-all self-start sm:self-auto min-h-[38px] ${
                  mfaActive ? 'bg-emerald-500/20 text-emerald-400 border border-emerald-500/40' : 'bg-[var(--k-surface-subtle)] text-[var(--k-text-secondary)]'
                }`}
              >
            ...
            <div className="p-4 bg-[var(--k-surface-raised)] border border-[rgba(255,255,255,0.07)] rounded-xl space-y-2">
              <label className="block text-xs font-mono text-[var(--k-text-secondary)] font-semibold">
              ...
              <input
                ...
                className="w-full px-3.5 py-2.5 bg-[var(--k-surface)] border border-[rgba(255,255,255,0.07)] rounded-xl text-xs text-white font-mono focus:outline-none focus:border-[var(--k-red)] min-h-[44px]"
              />
              <p className="text-[10px] text-[var(--k-text-muted)] font-mono">
                {language === 'id'
            ...
            <form onSubmit={handleUpdateSecurity} className="space-y-3 pt-3 border-t border-[rgba(255,255,255,0.07)]">
              ...
              <div className="pt-2 flex justify-end">
                <button
                  type="submit"
                  disabled={securityLoading}
                  className="px-5 py-2.5 rounded-xl bg-[var(--k-red)] text-white text-xs font-mono font-bold hover:bg-[var(--k-red-hover)] transition-all flex items-center gap-2 min-h-[44px]"
                >
                  <Save size={14} />
      ...
      {activeTab === 'api' && canAccessServer && (
        <div className="w-full max-w-4xl space-y-4">
          ...
          {canAccessServer && (
            <div className="p-4 rounded-xl bg-[var(--k-surface)] border border-[rgba(255,255,255,0.07)]">
              <div className="text-[10px] font-mono uppercase tracking-wider text-[var(--k-text-muted)]">Backup Retention</div>
              <div className="text-sm font-semibold text-white mt-1">{backupRetentionDays} days</div>
              <p className="text-[11px] text-[var(--k-text-muted)] font-mono mt-1">Provider-managed backup retention reported by the server.</p>
            </div>
          )}
          <div className="w-full max-w-4xl bg-[var(--k-surface)] border border-[rgba(255,255,255,0.07)] rounded-2xl p-5 sm:p-8 space-y-6">
          <div className="flex items-center gap-3 pb-4 border-b border-[rgba(255,255,255,0.07)]">
          ...
          <div className="space-y-4 text-xs font-mono">
            <div>
              ...
              <input
                ...
                className="w-full px-3.5 py-2.5 bg-[var(--k-surface-raised)] border border-[rgba(255,255,255,0.07)] rounded-xl text-white focus:outline-none focus:border-[var(--k-red)] font-mono min-h-[44px]"
              />
            </div>
            ...
            <div className="pt-3 border-t border-[rgba(255,255,255,0.07)]">
              <p className="text-[11px] text-[var(--k-text-muted)] font-mono">
                {language === 'id'
      ...
      {activeTab === 'audit' && canViewAuditLogs && (
        <div className="w-full bg-[var(--k-surface)] border border-[rgba(255,255,255,0.07)] rounded-2xl p-5 sm:p-8">
          ...
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-6 pb-4 border-b border-[rgba(255,255,255,0.07)]">
            ...
            <div className="flex items-center gap-2">
              <button
                ...
                className="px-3.5 py-2 rounded-xl bg-[var(--k-surface-raised)] hover:bg-[var(--k-surface-subtle)] text-white border border-[rgba(255,255,255,0.07)] text-xs font-mono transition-colors flex items-center gap-1.5 disabled:opacity-50 min-h-[40px]"
              >
                <Download size={13} />
              ...
              <button
                ...
                disabled={logs.length === 0}
                className="px-3.5 py-2 rounded-xl bg-[var(--k-surface-raised)] hover:bg-red-950/40 text-[var(--k-text-secondary)] hover:text-red-400 border border-[rgba(255,255,255,0.07)] hover:border-red-500/40 text-xs font-mono transition-colors flex items-center gap-1.5 disabled:opacity-50 min-h-[40px]"
              >
                <Trash2 size={13} />
          ...
          {logs.length === 0 ? (
            <div className="py-12 text-center text-[var(--k-text-secondary)] text-xs font-mono">
            ...
            <div className="space-y-2 max-h-[500px] overflow-y-auto pr-1 custom-scrollbar">
              {logs.map((log) => (
                <div
                  key={log.id}
                  className="p-3.5 rounded-xl bg-[var(--k-surface-raised)] border border-[rgba(255,255,255,0.07)] flex flex-col sm:flex-row sm:items-center justify-between gap-2 text-xs font-mono"
                >
                  ...
                  <div className="text-[10px] text-[var(--k-text-muted)] shrink-0 sm:text-right font-mono">
