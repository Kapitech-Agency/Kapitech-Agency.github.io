  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          <h1 className="text-xl sm:text-2xl font-bold font-sans text-white tracking-tight flex items-center gap-2.5">
            <Users className="text-[var(--k-red)]" size={24} />
        ...
        <div className="flex items-center gap-3 shrink-0">
          <button
            ...
            className="h-10 px-4 rounded-xl bg-[var(--k-red)] hover:bg-[var(--k-red-hover)] text-white text-xs font-semibold shadow-lg shadow-[var(--k-red)]/25 flex items-center gap-2 transition-all min-h-[40px]"
          >
            <Plus size={15} />
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4 w-full">
        <div className="w-full h-full p-4 rounded-xl bg-[var(--k-surface)] border border-[rgba(255,255,255,0.07)] flex flex-col justify-between">
          <div className="text-[11px] font-mono text-[var(--k-text-secondary)] uppercase tracking-wider">
        ...
        <div className="w-full h-full p-4 rounded-xl bg-[var(--k-surface)] border border-[rgba(255,255,255,0.07)] flex flex-col justify-between">
          ...
          <div className="text-[10px] font-mono text-[var(--k-text-secondary)] mt-1">Design, Dev & 3D</div>
        </div>
        ...
        <div className="w-full h-full p-4 rounded-xl bg-[var(--k-surface)] border border-[rgba(255,255,255,0.07)] flex flex-col justify-between">
          ...
          <div className="text-[10px] font-mono text-[var(--k-text-secondary)] mt-1">From 42 verified deliverables</div>
        </div>
      </div>

      {/* Filter & Search Bar */}
      <div className="w-full p-4 rounded-xl bg-[var(--k-surface)] border border-[rgba(255,255,255,0.07)] flex flex-col lg:flex-row items-center justify-between gap-3">
        <div className="relative w-full lg:w-96">
          ...
          <input
            ...
            className="w-full pl-9 pr-3 py-2 rounded-xl bg-[var(--k-surface-raised)] border border-[rgba(255,255,255,0.07)] text-xs font-sans text-white placeholder:text-[#5C626E] focus:outline-none focus:border-[var(--k-red)] h-10 min-h-[40px]"
          />
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-4 w-full">
        {filteredVendors.map(vendor => (
          <div
            key={vendor.id}
            className="w-full h-full p-5 rounded-xl bg-[var(--k-surface)] border border-[rgba(255,255,255,0.07)] hover:border-[rgba(255,255,255,0.14)] transition-all flex flex-col justify-between group"
          >
            <div>
              {/* Header Card */}
              <div className="flex items-start justify-between gap-3">
                <div className="flex items-center gap-3">
                  <div className="w-11 h-11 rounded-xl bg-[var(--k-surface-raised)] border border-[rgba(255,255,255,0.07)] flex items-center justify-center font-bold text-sm text-white shadow-inner">
                    {vendor.name.charAt(0).toUpperCase()}
                  </div>
                  <div>
                    <div className="flex items-center gap-1.5 flex-wrap">
                      <h3 className="text-sm font-bold text-white group-hover:text-[var(--k-red)] transition-colors">
                        {vendor.name}
                      </h3>
                      {(vendor.isVetted ?? true) && (
                        <span 
                          ...
                          className="inline-flex items-center gap-0.5 px-1.5 py-0.5 rounded-full text-[9px] font-mono font-bold bg-[var(--k-red)]/15 text-[var(--k-red-hover)] border border-[var(--k-red)]/30 cursor-pointer hover:bg-[var(--k-red)]/25 transition-colors"
                        >
                          <ShieldCheck size={10} />
                          <span>Vetted</span>
                        </span>
                    ...
                    {vendor.companyName && (
                      <p className="text-[11px] font-mono text-[var(--k-text-secondary)] flex items-center gap-1">
              ...
              <div className="mt-3.5 space-y-1.5">
                ...
                <div className="flex flex-wrap gap-1.5">
                  {vendor.skills.map((skill, idx) => (
                    <span
                      key={idx}
                      className="px-2 py-0.5 rounded-md bg-[var(--k-surface-raised)] border border-[rgba(255,255,255,0.07)] text-[10px] font-mono text-[var(--k-text-secondary)]"
                    >
                      {skill}
                    </span>
                  ))}
            ...
            <div className="mt-5 pt-3.5 border-t border-[rgba(255,255,255,0.07)] flex items-center justify-between">
              ...
              <div className="flex items-center gap-1.5">
                <button
                  ...
                  className="px-2.5 py-1 rounded-lg bg-[var(--k-surface-raised)] hover:bg-[var(--k-surface-subtle)] border border-[rgba(255,255,255,0.07)] text-xs font-sans text-white transition-colors"
                >
                ...
                <button
                  onClick={() => handleOpenEdit(vendor)}
                                  disabled={!canManageVendors}
                  className="p-1.5 rounded-lg bg-[var(--k-surface-raised)] hover:bg-[var(--k-surface-subtle)] border border-[rgba(255,255,255,0.07)] text-[var(--k-text-secondary)] hover:text-white transition-colors"
                  title="Edit Vendor"
                >
                  <Edit3 size={13} />
                </button>
                <button
                  onClick={() => handleDeleteVendor(vendor.id, vendor.name)}
                           disabled={!canManageVendors}
                  className="p-1.5 rounded-lg bg-[var(--k-surface-raised)] hover:bg-red-950/40 border border-[rgba(255,255,255,0.07)] text-[var(--k-text-secondary)] hover:text-red-400 transition-colors"
                  title="Delete Vendor"
                >
                  <Trash2 size={13} />
                </button>
      ...
      {filteredVendors.length === 0 && (
        <div className="w-full p-12 rounded-xl bg-[var(--k-surface)] border border-[rgba(255,255,255,0.07)] text-center">
          ...
          <p className="text-xs font-sans text-[var(--k-text-secondary)] mt-1 max-w-sm mx-auto">
            {language === 'id'
      ...
      {isDrawerOpen && selectedVendor && (
        <div className="fixed inset-0 z-50 flex">
          ...
          <div className="relative ml-auto w-full max-w-md bg-[var(--k-surface)] border-l border-[rgba(255,255,255,0.07)] h-full flex flex-col justify-between p-6 z-10 shadow-2xl overflow-y-auto animate-in slide-in-from-right duration-200">
            <div>
              <div className="flex items-center justify-between pb-4 border-b border-[rgba(255,255,255,0.07)]">
                <div className="flex items-center gap-3">
                  <div className="w-10 h-10 rounded-xl bg-[var(--k-red)] flex items-center justify-center font-bold text-white text-sm">
                  ...
                  <div>
                    <div className="flex items-center gap-2">
                      ...
                      {(selectedVendor.isVetted ?? true) && (
                        <span className="inline-flex items-center gap-0.5 px-2 py-0.5 rounded-full text-[10px] font-mono font-bold bg-[var(--k-red)]/15 text-[var(--k-red-hover)] border border-[var(--k-red)]/30">
                          <ShieldCheck size={11} />
                          <span>Vetted</span>
                        </span>
                      )}
                    </div>
                    <p className="text-xs font-mono text-[var(--k-text-secondary)]">{selectedVendor.primaryCategory}</p>
                  </div>
                </div>
                <button
                  onClick={() => setIsDrawerOpen(false)}
                  className="p-1.5 rounded-lg bg-[var(--k-surface-raised)] text-[var(--k-text-secondary)] hover:text-white border border-[rgba(255,255,255,0.07)]"
                >
                  <X size={15} />
                </button>
              </div>
              ...
              <div className="py-4 space-y-4 text-xs font-sans">
                <div>
                  ...
                  <div className="space-y-1.5 bg-[var(--k-surface-raised)] p-3 rounded-xl border border-[rgba(255,255,255,0.07)]">
                    <div className="flex items-center gap-2 text-[var(--k-text-secondary)]">
                ...
                <div>
                  ...
                  <div className="bg-[var(--k-surface-raised)] p-3 rounded-xl border border-[rgba(255,255,255,0.07)] flex items-center justify-between">
                    <div>
                      <span className="text-[10px] font-mono text-[var(--k-text-secondary)]">Standard Hourly</span>
                      <p className="text-sm font-mono font-bold text-emerald-400">
                        {formatAmount(selectedVendor.hourlyRate, currency)}/hr
                      </p>
                    </div>
                    <div className="text-right">
                      <span className="text-[10px] font-mono text-[var(--k-text-secondary)]">Engagement</span>
                ...
                {selectedVendor.notes && (
                  <div>
                    ...
                    <div className="bg-[var(--k-surface-raised)] p-3 rounded-xl border border-[rgba(255,255,255,0.07)] text-[var(--k-text-secondary)] leading-relaxed">
                      {selectedVendor.notes}
                    </div>
                  </div>
                )}
            ...
            <div className="pt-4 border-t border-[rgba(255,255,255,0.07)] flex items-center justify-end gap-2">
              <button
                ...
                className="px-4 py-2 rounded-xl bg-[var(--k-red)] hover:bg-[var(--k-red-hover)] text-white text-xs font-semibold"
              >
      ...
      {isModalOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
          ...
          <div className="relative w-full max-w-lg bg-[var(--k-surface)] border border-[rgba(255,255,255,0.07)] rounded-xl shadow-2xl p-6 z-10 animate-in zoom-in-95 duration-150">
            <div className="flex items-center justify-between pb-4 border-b border-[rgba(255,255,255,0.07)]">
              <h3 className="text-sm font-bold text-white">
                {editingVendor
                  ? language === 'id'
            ...
            <form onSubmit={handleSaveVendor} className="py-4 space-y-3.5 max-h-[75vh] overflow-y-auto pr-1 custom-scrollbar">
              <div className="grid grid-cols-2 gap-3">
                <div>
                  <label className="text-[11px] font-mono text-[var(--k-text-secondary)] uppercase block mb-1">
                  ...
                  <input
                    ...
                    className="w-full px-3 py-2 rounded-xl bg-[var(--k-surface-raised)] border border-[rgba(255,255,255,0.07)] text-xs font-sans text-white focus:outline-none focus:border-[var(--k-red)]"
                  />
                </div>
              ...
              <div className="grid grid-cols-2 gap-3">
                <div>
                  <label className="text-[11px] font-mono text-[var(--k-text-secondary)] uppercase block mb-1">Email *</label>
                  <input
                    type="email"
                    required
                    value={formEmail}
              ...
              <div className="grid grid-cols-2 gap-3">
                ...
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-3 py-2 rounded-xl bg-[var(--k-surface-raised)] border border-[rgba(255,255,255,0.07)] text-xs font-mono text-white focus:outline-none focus:border-[var(--k-red)]"
                  />
                </div>
              </div>
              ...
              <div className="p-3 rounded-xl bg-[var(--k-surface-raised)] border border-[rgba(255,255,255,0.07)] flex items-center justify-between">
                <div>
                ...
                <input
                  ...
                  className="w-4 h-4 rounded bg-[var(--k-surface)] border-white/20 text-[var(--k-red)] focus:ring-0 focus:ring-offset-0 cursor-pointer"
                />
              </div>
              ...
              <div className="pt-4 border-t border-[rgba(255,255,255,0.07)] flex items-center justify-end gap-2">
                <button
                  type="button"
                  onClick={() => setIsModalOpen(false)}
                  className="px-4 py-2 rounded-xl bg-[var(--k-surface-raised)] hover:bg-[var(--k-surface-subtle)] text-white text-xs font-semibold border border-[rgba(255,255,255,0.07)]"
                >
                  {language === 'id' ? 'Batal' : 'Cancel'}
                </button>
                <button
                  type="submit"
                  className="px-5 py-2 rounded-xl bg-[var(--k-red)] hover:bg-[var(--k-red-hover)] text-white text-xs font-semibold shadow-lg shadow-[var(--k-red)]/25"
                >
