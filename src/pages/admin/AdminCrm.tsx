          ...
          <div className="ams-kanban-scroll flex gap-4 min-w-[1400px] xl:min-w-full items-start">
            ...
            {CRM_STAGE_DEFINITIONS.map((stageDef) => {
              ...
              return (
                ...
                >
                  {/* Column Header */}
                  <div className="p-3 border-b border-[var(--line)] flex items-center justify-between bg-[var(--panel)] rounded-t-[12px]">
              ...
              filteredLeads.map((lead) => (
                ...
                >
                  ...
                  <div className="flex items-start justify-between gap-2">
                    ...
                    <span className="px-2.5 py-1 rounded-control bg-[var(--panel)] border border-[var(--line)] text-[11px] font-sans text-[var(--text)] shrink-0 font-semibold">
                      {language === 'id'
