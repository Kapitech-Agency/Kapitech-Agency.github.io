    ...
    <div className="relative min-h-screen bg-[#0A0A0A] text-white selection:bg-brand-red selection:text-white pt-28 pb-24 overflow-hidden">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="lg:col-span-8">
            ...
            <div className="flex flex-wrap items-center gap-4">
              <Link
                ...
                className="inline-flex items-center justify-center gap-2 px-7 py-3.5 rounded-full bg-brand-red text-white font-semibold text-sm hover:bg-white hover:text-black transition-all duration-300 shadow-[0_0_25px_rgba(255,26,26,0.3)] group"
              >
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 items-center">
              ...
              <div className="lg:col-span-5 w-full">
                <div className="rounded-2xl border border-[#2A2A2A] bg-[#0A0A0A] p-6 sm:p-8 space-y-5 text-center">
                  ...
                  <Link
                    to={`/contact?service=${encodeURIComponent(service.title)}`}
                    className="w-full inline-flex items-center justify-center gap-2 px-6 py-3.5 rounded-full bg-brand-red text-white font-semibold text-sm hover:bg-white hover:text-black transition-all duration-300 shadow-[0_0_20px_rgba(255,26,26,0.3)]"
                  >
        ...
        <div className="pt-12 border-t border-[#2A2A2A] flex flex-col sm:flex-row items-center justify-between gap-6">
          ...
          <Link
            to="/contact"
            className="inline-flex items-center gap-2 px-6 py-3 rounded-full bg-brand-red text-white text-sm font-medium hover:bg-white hover:text-black transition-all shadow-[0_0_20px_rgba(255,26,26,0.3)]"
          >
