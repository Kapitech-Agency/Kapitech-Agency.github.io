      ...
      <div className="max-w-4xl mx-auto relative z-10">
        ...
        {language === 'id' ? (
          <div className="space-y-14 text-[15px] md:text-base leading-[1.75] text-[var(--k-text-secondary)]">
            <section>
              <h2 className="text-[clamp(21px,2.2vw,26px)] leading-[1.18] font-sans font-bold text-white mb-4 tracking-[-0.025em]">1. Pendahuluan</h2>
              <p>
            ...
            <section>
              <h2 className="text-[clamp(21px,2.2vw,26px)] leading-[1.18] font-sans font-bold text-white mb-4 tracking-[-0.025em]">2. Informasi yang Kami Kumpulkan</h2>
            ...
            <section>
              <h2 className="text-[clamp(21px,2.2vw,26px)] leading-[1.18] font-sans font-bold text-white mb-4 tracking-[-0.025em]">3. Penggunaan Informasi Anda</h2>
            ...
            <section>
              <h2 className="text-[clamp(21px,2.2vw,26px)] leading-[1.18] font-sans font-bold text-white mb-4 tracking-[-0.025em]">4. Pengungkapan & Perlindungan Data</h2>
              <p>
            ...
            <section>
              <h2 className="text-[clamp(21px,2.2vw,26px)] leading-[1.18] font-sans font-bold text-white mb-4 tracking-[-0.025em]">5. Keamanan Informasi</h2>
              <p>
            ...
            <section>
              <h2 className="text-[clamp(21px,2.2vw,26px)] leading-[1.18] font-sans font-bold text-white mb-4 tracking-[-0.025em]">6. Hubungi Kami</h2>
              <p>
          ...
          <div className="space-y-14 text-[15px] md:text-base leading-[1.75] text-[var(--k-text-secondary)]">
            <section>
              <h2 className="text-[clamp(21px,2.2vw,26px)] leading-[1.18] font-sans font-bold text-white mb-4 tracking-[-0.025em]">1. Introduction</h2>
              <p>
            ...
            <section>
              <h2 className="text-[clamp(21px,2.2vw,26px)] leading-[1.18] font-sans font-bold text-white mb-4 tracking-[-0.025em]">2. Information We Collect</h2>
            ...
            <section>
              <h2 className="text-[clamp(21px,2.2vw,26px)] leading-[1.18] font-sans font-bold text-white mb-4 tracking-[-0.025em]">3. Use of Your Information</h2>
            ...
            <section>
              <h2 className="text-[clamp(21px,2.2vw,26px)] leading-[1.18] font-sans font-bold text-white mb-4 tracking-[-0.025em]">4. Disclosure & Data Protection</h2>
              <p>
            ...
            <section>
              <h2 className="text-[clamp(21px,2.2vw,26px)] leading-[1.18] font-sans font-bold text-white mb-4 tracking-[-0.025em]">5. Security of Your Information</h2>
              <p>
            ...
            <section>
              <h2 className="text-[clamp(21px,2.2vw,26px)] leading-[1.18] font-sans font-bold text-white mb-4 tracking-[-0.025em]">6. Contact Us</h2>
              <p>
