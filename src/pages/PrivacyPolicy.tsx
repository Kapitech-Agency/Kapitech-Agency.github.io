      ...
      <div className="max-w-4xl mx-auto relative z-10">
        ...
        {language === 'id' ? (
          <div className="space-y-12 text-base md:text-lg leading-relaxed text-[[var(--k-text-secondary)]]">
            <section>
              <h2 className="text-2xl font-sans font-bold text-white mb-4">1. Pendahuluan</h2>
              <p>
            ...
            <section>
              <h2 className="text-2xl font-sans font-bold text-white mb-4">2. Informasi yang Kami Kumpulkan</h2>
            ...
            <section>
              <h2 className="text-2xl font-sans font-bold text-white mb-4">3. Penggunaan Informasi Anda</h2>
            ...
            <section>
              <h2 className="text-2xl font-sans font-bold text-white mb-4">4. Pengungkapan & Perlindungan Data</h2>
              <p>
            ...
            <section>
              <h2 className="text-2xl font-sans font-bold text-white mb-4">5. Keamanan Informasi</h2>
              <p>
            ...
            <section>
              <h2 className="text-2xl font-sans font-bold text-white mb-4">6. Hubungi Kami</h2>
              <p>
          ...
          <div className="space-y-12 text-base md:text-lg leading-relaxed text-[[var(--k-text-secondary)]]">
            <section>
              <h2 className="text-2xl font-sans font-bold text-white mb-4">1. Introduction</h2>
              <p>
            ...
            <section>
              <h2 className="text-2xl font-sans font-bold text-white mb-4">2. Information We Collect</h2>
            ...
            <section>
              <h2 className="text-2xl font-sans font-bold text-white mb-4">3. Use of Your Information</h2>
            ...
            <section>
              <h2 className="text-2xl font-sans font-bold text-white mb-4">4. Disclosure & Data Protection</h2>
              <p>
            ...
            <section>
              <h2 className="text-2xl font-sans font-bold text-white mb-4">5. Security of Your Information</h2>
              <p>
            ...
            <section>
              <h2 className="text-2xl font-sans font-bold text-white mb-4">6. Contact Us</h2>
              <p>
