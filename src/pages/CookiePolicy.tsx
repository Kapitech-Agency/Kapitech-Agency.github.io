      ...
      <div className="max-w-4xl mx-auto relative z-10">
        ...
        {language === 'id' ? (
          <div className="space-y-14 text-[15px] md:text-base leading-[1.75] text-[var(--k-text-secondary)]">
            <section>
              <h2 className="text-[clamp(21px,2.2vw,26px)] leading-[1.18] font-sans font-bold text-white mb-4 tracking-[-0.025em]">1. Apa Itu Cookie?</h2>
              <p>
            ...
            <section>
              <h2 className="text-[clamp(21px,2.2vw,26px)] leading-[1.18] font-sans font-bold text-white mb-4 tracking-[-0.025em]">2. Kategori Cookie yang Kami Gunakan</h2>
            ...
            <section>
              <h2 className="text-[clamp(21px,2.2vw,26px)] leading-[1.18] font-sans font-bold text-white mb-4 tracking-[-0.025em]">3. Pengendalian & Penolakan Cookie</h2>
              <p>
            ...
            <section>
              <h2 className="text-[clamp(21px,2.2vw,26px)] leading-[1.18] font-sans font-bold text-white mb-4 tracking-[-0.025em]">4. Hubungi Kami</h2>
              <p>
          ...
          <div className="space-y-14 text-[15px] md:text-base leading-[1.75] text-[var(--k-text-secondary)]">
            <section>
              <h2 className="text-[clamp(21px,2.2vw,26px)] leading-[1.18] font-sans font-bold text-white mb-4 tracking-[-0.025em]">1. What Are Cookies?</h2>
              <p>
            ...
            <section>
              <h2 className="text-[clamp(21px,2.2vw,26px)] leading-[1.18] font-sans font-bold text-white mb-4 tracking-[-0.025em]">2. Categories of Cookies We Use</h2>
            ...
            <section>
              <h2 className="text-[clamp(21px,2.2vw,26px)] leading-[1.18] font-sans font-bold text-white mb-4 tracking-[-0.025em]">3. Managing & Disabling Cookies</h2>
              <p>
            ...
            <section>
              <h2 className="text-[clamp(21px,2.2vw,26px)] leading-[1.18] font-sans font-bold text-white mb-4 tracking-[-0.025em]">4. Inquiries</h2>
              <p>
