...
export const CookiePolicy = () => {
  ...
  return (
    <motion.div
      ...
      animate={{ opacity: 1 }}
      exit={{ opacity: 0 }}
      className="min-h-screen pt-28 sm:pt-36 md:pt-40 pb-16 sm:pb-20 px-4 sm:px-6 md:px-12 bg-[var(--k-bg)] text-[#8E8E93] font-light relative selection:bg-brand-red selection:text-white"
    >
