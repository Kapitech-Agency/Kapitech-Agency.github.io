      ...
      <div className="max-w-4xl mx-auto relative z-10">
        ...
        {language === 'id' ? (
          <div className="space-y-12 text-base md:text-lg leading-relaxed text-[var(--k-text-secondary)]">
            <section>
              <h2 className="text-2xl font-sans font-bold text-white mb-4">1. Apa Itu Cookie?</h2>
              <p>
            ...
            <section>
              <h2 className="text-2xl font-sans font-bold text-white mb-4">2. Kategori Cookie yang Kami Gunakan</h2>
            ...
            <section>
              <h2 className="text-2xl font-sans font-bold text-white mb-4">3. Pengendalian & Penolakan Cookie</h2>
              <p>
            ...
            <section>
              <h2 className="text-2xl font-sans font-bold text-white mb-4">4. Hubungi Kami</h2>
              <p>
          ...
          <div className="space-y-12 text-base md:text-lg leading-relaxed text-[var(--k-text-secondary)]">
            <section>
              <h2 className="text-2xl font-sans font-bold text-white mb-4">1. What Are Cookies?</h2>
              <p>
            ...
            <section>
              <h2 className="text-2xl font-sans font-bold text-white mb-4">2. Categories of Cookies We Use</h2>
            ...
            <section>
              <h2 className="text-2xl font-sans font-bold text-white mb-4">3. Managing & Disabling Cookies</h2>
              <p>
            ...
            <section>
              <h2 className="text-2xl font-sans font-bold text-white mb-4">4. Inquiries</h2>
              <p>
