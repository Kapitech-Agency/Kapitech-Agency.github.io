      ...
      <div className="max-w-4xl mx-auto relative z-10">
        ...
        {language === 'id' ? (
          <div className="space-y-12 text-base md:text-lg leading-relaxed text-[[var(--k-text-secondary)]]">
            <section>
              <h2 className="text-2xl font-sans font-bold text-white mb-4">1. Penerimaan Ketentuan</h2>
              <p>
            ...
            <section>
              <h2 className="text-2xl font-sans font-bold text-white mb-4">2. Deskripsi Layanan & Lingkup Kerja</h2>
              <p>
            ...
            <section>
              <h2 className="text-2xl font-sans font-bold text-white mb-4">3. Hak Kekayaan Intelektual (IP Rights)</h2>
              <p>
            ...
            <section>
              <h2 className="text-2xl font-sans font-bold text-white mb-4">4. Perjanjian Kerahasiaan (NDA) & Keamanan</h2>
              <p>
            ...
            <section>
              <h2 className="text-2xl font-sans font-bold text-white mb-4">5. Garansi & Pemeliharaan Pasca-Peluncuran</h2>
              <p>
            ...
            <section>
              <h2 className="text-2xl font-sans font-bold text-white mb-4">6. Batasan Tanggung Jawab</h2>
              <p>
            ...
            <section>
              <h2 className="text-2xl font-sans font-bold text-white mb-4">7. Hukum yang Mengatur</h2>
              <p>
            ...
            <section>
              <h2 className="text-2xl font-sans font-bold text-white mb-4">8. Kontak Resmi</h2>
              <p>
          ...
          <div className="space-y-12 text-base md:text-lg leading-relaxed text-[[var(--k-text-secondary)]]">
            <section>
              <h2 className="text-2xl font-sans font-bold text-white mb-4">1. Acceptance of Terms</h2>
              <p>
            ...
            <section>
              <h2 className="text-2xl font-sans font-bold text-white mb-4">2. Description of Services & Scope</h2>
              <p>
            ...
            <section>
              <h2 className="text-2xl font-sans font-bold text-white mb-4">3. Intellectual Property Ownership</h2>
              <p>
            ...
            <section>
              <h2 className="text-2xl font-sans font-bold text-white mb-4">4. Confidentiality & Non-Disclosure</h2>
              <p>
            ...
            <section>
              <h2 className="text-2xl font-sans font-bold text-white mb-4">5. Post-Launch Warranty & SLAs</h2>
              <p>
            ...
            <section>
              <h2 className="text-2xl font-sans font-bold text-white mb-4">6. Limitation of Liability</h2>
              <p>
            ...
            <section>
              <h2 className="text-2xl font-sans font-bold text-white mb-4">7. Governing Law</h2>
              <p>
            ...
            <section>
              <h2 className="text-2xl font-sans font-bold text-white mb-4">8. Contact Us</h2>
              <p>
