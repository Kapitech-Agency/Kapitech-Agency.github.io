      ...
      <div className="max-w-4xl mx-auto relative z-10">
        ...
        {language === 'id' ? (
          <div className="space-y-14 text-[15px] md:text-base leading-[1.75] text-[var(--k-text-secondary)]">
            <section>
              <h2 className="text-[clamp(21px,2.2vw,26px)] leading-[1.18] font-sans font-bold text-white mb-4 tracking-[-0.025em]">1. Penerimaan Ketentuan</h2>
              <p>
            ...
            <section>
              <h2 className="text-[clamp(21px,2.2vw,26px)] leading-[1.18] font-sans font-bold text-white mb-4 tracking-[-0.025em]">2. Deskripsi Layanan & Lingkup Kerja</h2>
              <p>
            ...
            <section>
              <h2 className="text-[clamp(21px,2.2vw,26px)] leading-[1.18] font-sans font-bold text-white mb-4 tracking-[-0.025em]">3. Hak Kekayaan Intelektual (IP Rights)</h2>
              <p>
            ...
            <section>
              <h2 className="text-[clamp(21px,2.2vw,26px)] leading-[1.18] font-sans font-bold text-white mb-4 tracking-[-0.025em]">4. Perjanjian Kerahasiaan (NDA) & Keamanan</h2>
              <p>
            ...
            <section>
              <h2 className="text-[clamp(21px,2.2vw,26px)] leading-[1.18] font-sans font-bold text-white mb-4 tracking-[-0.025em]">5. Garansi & Pemeliharaan Pasca-Peluncuran</h2>
              <p>
            ...
            <section>
              <h2 className="text-[clamp(21px,2.2vw,26px)] leading-[1.18] font-sans font-bold text-white mb-4 tracking-[-0.025em]">6. Batasan Tanggung Jawab</h2>
              <p>
            ...
            <section>
              <h2 className="text-[clamp(21px,2.2vw,26px)] leading-[1.18] font-sans font-bold text-white mb-4 tracking-[-0.025em]">7. Hukum yang Mengatur</h2>
              <p>
            ...
            <section>
              <h2 className="text-[clamp(21px,2.2vw,26px)] leading-[1.18] font-sans font-bold text-white mb-4 tracking-[-0.025em]">8. Kontak Resmi</h2>
              <p>
          ...
          <div className="space-y-14 text-[15px] md:text-base leading-[1.75] text-[var(--k-text-secondary)]">
            <section>
              <h2 className="text-[clamp(21px,2.2vw,26px)] leading-[1.18] font-sans font-bold text-white mb-4 tracking-[-0.025em]">1. Acceptance of Terms</h2>
              <p>
            ...
            <section>
              <h2 className="text-[clamp(21px,2.2vw,26px)] leading-[1.18] font-sans font-bold text-white mb-4 tracking-[-0.025em]">2. Description of Services & Scope</h2>
              <p>
            ...
            <section>
              <h2 className="text-[clamp(21px,2.2vw,26px)] leading-[1.18] font-sans font-bold text-white mb-4 tracking-[-0.025em]">3. Intellectual Property Ownership</h2>
              <p>
            ...
            <section>
              <h2 className="text-[clamp(21px,2.2vw,26px)] leading-[1.18] font-sans font-bold text-white mb-4 tracking-[-0.025em]">4. Confidentiality & Non-Disclosure</h2>
              <p>
            ...
            <section>
              <h2 className="text-[clamp(21px,2.2vw,26px)] leading-[1.18] font-sans font-bold text-white mb-4 tracking-[-0.025em]">5. Post-Launch Warranty & SLAs</h2>
              <p>
            ...
            <section>
              <h2 className="text-[clamp(21px,2.2vw,26px)] leading-[1.18] font-sans font-bold text-white mb-4 tracking-[-0.025em]">6. Limitation of Liability</h2>
              <p>
            ...
            <section>
              <h2 className="text-[clamp(21px,2.2vw,26px)] leading-[1.18] font-sans font-bold text-white mb-4 tracking-[-0.025em]">7. Governing Law</h2>
              <p>
            ...
            <section>
              <h2 className="text-[clamp(21px,2.2vw,26px)] leading-[1.18] font-sans font-bold text-white mb-4 tracking-[-0.025em]">8. Contact Us</h2>
              <p>
