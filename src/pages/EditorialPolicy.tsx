      ...
      <div className="max-w-4xl mx-auto relative z-10">
        ...
        {language === 'id' ? (
          <div className="space-y-12 text-base md:text-lg leading-relaxed text-[var(--k-text-secondary)]">
            ...
            <section>
              <h2 className="text-2xl font-sans font-bold text-white mb-4">2. Verifikasi Faktual & Ketelitian Teknis</h2>
            ...
            <section>
              <h2 className="text-2xl font-sans font-bold text-white mb-4">3. Transparansi Studi Kasus & Hak Klien</h2>
              <p>
            ...
            <section>
              <h2 className="text-2xl font-sans font-bold text-white mb-4">4. Kebijakan Koreksi & Pembaruan</h2>
              <p>
            ...
            <section>
              <h2 className="text-2xl font-sans font-bold text-white mb-4">5. Pengajuan Umpan Balik</h2>
              <p>
          ...
          <div className="space-y-12 text-base md:text-lg leading-relaxed text-[var(--k-text-secondary)]">
            ...
            <section>
              <h2 className="text-2xl font-sans font-bold text-white mb-4">2. Factual Verification & Technical Rigor</h2>
            ...
            <section>
              <h2 className="text-2xl font-sans font-bold text-white mb-4">3. Case Study Transparency & Client Protection</h2>
              <p>
            ...
            <section>
              <h2 className="text-2xl font-sans font-bold text-white mb-4">4. Corrections & Versioning Policy</h2>
              <p>
            ...
            <section>
              <h2 className="text-2xl font-sans font-bold text-white mb-4">5. Feedback & Inquiries</h2>
              <p>
