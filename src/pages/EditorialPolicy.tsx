      ...
      <div className="max-w-4xl mx-auto relative z-10">
        ...
        {language === 'id' ? (
          <div className="space-y-14 text-[15px] md:text-base leading-[1.75] text-[var(--k-text-secondary)]">
            <section>
              <h2 className="text-[clamp(21px,2.2vw,26px)] leading-[1.18] font-sans font-bold text-white mb-4 tracking-[-0.025em]">1. Komitmen Integritas Konten</h2>
              <p>
            ...
            <section>
              <h2 className="text-[clamp(21px,2.2vw,26px)] leading-[1.18] font-sans font-bold text-white mb-4 tracking-[-0.025em]">2. Verifikasi Faktual & Ketelitian Teknis</h2>
            ...
            <section>
              <h2 className="text-[clamp(21px,2.2vw,26px)] leading-[1.18] font-sans font-bold text-white mb-4 tracking-[-0.025em]">3. Transparansi Studi Kasus & Hak Klien</h2>
              <p>
            ...
            <section>
              <h2 className="text-[clamp(21px,2.2vw,26px)] leading-[1.18] font-sans font-bold text-white mb-4 tracking-[-0.025em]">4. Kebijakan Koreksi & Pembaruan</h2>
              <p>
            ...
            <section>
              <h2 className="text-[clamp(21px,2.2vw,26px)] leading-[1.18] font-sans font-bold text-white mb-4 tracking-[-0.025em]">5. Pengajuan Umpan Balik</h2>
              <p>
          ...
          <div className="space-y-14 text-[15px] md:text-base leading-[1.75] text-[var(--k-text-secondary)]">
            <section>
              <h2 className="text-[clamp(21px,2.2vw,26px)] leading-[1.18] font-sans font-bold text-white mb-4 tracking-[-0.025em]">1. Content Integrity Commitment</h2>
              <p>
            ...
            <section>
              <h2 className="text-[clamp(21px,2.2vw,26px)] leading-[1.18] font-sans font-bold text-white mb-4 tracking-[-0.025em]">2. Factual Verification & Technical Rigor</h2>
            ...
            <section>
              <h2 className="text-[clamp(21px,2.2vw,26px)] leading-[1.18] font-sans font-bold text-white mb-4 tracking-[-0.025em]">3. Case Study Transparency & Client Protection</h2>
              <p>
            ...
            <section>
              <h2 className="text-[clamp(21px,2.2vw,26px)] leading-[1.18] font-sans font-bold text-white mb-4 tracking-[-0.025em]">4. Corrections & Versioning Policy</h2>
              <p>
            ...
            <section>
              <h2 className="text-[clamp(21px,2.2vw,26px)] leading-[1.18] font-sans font-bold text-white mb-4 tracking-[-0.025em]">5. Feedback & Inquiries</h2>
              <p>
